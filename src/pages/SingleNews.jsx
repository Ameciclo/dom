...
function SingleNews(props) {
  ...
  const dataNew = [
    ...
    {title: "Semana da Mobilidade 2024 acontecerá de 22 a 30 de setembro", text: "Prepare-se para a Semana da Mobilidade 2024!\n\n Vamos celebrar o Dia Mundial Sem Carro, participar do Desafio Intermodal, e muito mais! Vamos transformar a mobilidade urbana em Recife. Marque na sua agenda e junte-se a nós!\n\n Programação Completa em Breve. Fique de olho para mais detalhes e novidades!", img: news_img_01}
